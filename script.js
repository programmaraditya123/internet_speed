...
//         //this function triggers once the image loads
//         time_end = new Date().getTime();
//         var timeDuration = (time_end - time_start) / 1000;
//         loadbytes = dowloadsize * 8,
//             totalSpeed = ((loadbytes / timeDuration) / 1024 / 1024).toFixed(2);
//         let i = 0, speedOut;
//         const animate = () => {
//             if (i < totalSpeed) {
//                 document.querySelector('.content').innerHTML = i.toFixed(2) + '<samll>Mbps</small>';
